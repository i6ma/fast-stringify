...
const logsCapturer = require('./logscapturer.js');
const updateReadme = process.argv[2] === 'updateReadme';
...
updateReadme && logsCapturer.start();
runShallowSuite()
  .then(runDeepSuite)
  ...
  .then(function () {
    ...
    var logs = logsCapturer.stop();
    // var tables = logsCapturer.getTables(logs, 'printTable');
    var tables = logsCapturer.getTables(logs);
    logsCapturer.updateReadme(tables);
  });
